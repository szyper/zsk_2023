...
namespace _12_1_konstruktory.classes
{
  internal class Person
  {
    ...
    //konstruktor parametryczny klasy Person z dwoma parametrami
    ...
    //konstruktor parametryczny klasy Person z trzema parametrami
    //this służy do wywołania innego konstruktora tej samej klasy, czyli konstruktora z dwoma parametrami. Dzięki temu konstruktor z trzema parametrami nie musi inicjować pól Name, Surname a może skupić się na dodaniu pola Age. Jest to sposób na uniknięcie powtarzania kodu i zapewnienia spójności danych
    ...
    //konstruktor parametryczny klasy Person z czterema parametrami
